...
void yespower_hash(const char* input, char* output)
{
    ...
    yespower_tls((const uint8_t *)input, 80, &yespower_1_0, (yespower_binary_t *)output);
}
...
void yespowerIC_hash(const char* input, char* output)
{
    ...
    yespower_tls((const uint8_t *)input, 80, &yespower_1_0_isotopec, (yespower_binary_t *)output);
}
...
void yespowerIOTS_hash(const char* input, char* output)
{
    ...
    yespower_tls((const uint8_t *)input, 80, &yespower_1_0_iots, (yespower_binary_t *)output);
}
...
void yespowerR16_hash(const char* input, char* output)
{
    ...
    yespower_tls((const uint8_t *)input, 80, &yespower_1_0_r16, (yespower_binary_t *)output);
}
...
void yespowerRES_hash(const char* input, char* output)
{
    ...
    yespower_tls((const uint8_t *)input, 140, &yespower_1_0_resistance, (yespower_binary_t *)output);
}
...
void yespowerSUGAR_hash(const char* input, char* output)
{
    ...
    yespower_tls((const uint8_t *)input, 80, &yespower_1_0_sugarchain, (yespower_binary_t *)output);
}
...
void yespowerURX_hash(const char* input, char* output, uint32_t len)
{
    ...
    yespower_tls((const uint8_t *)input, len, &yespower_1_0_uraniumx, (yespower_binary_t *)output);
}
...
void yespowerLTNCG_hash(const char* input, char* output, uint32_t len)
{
    ...
    yespower_tls((const uint8_t *)input, len, &yespower_1_0_ltncg, (yespower_binary_t *)output);
}
...
void yespowerLITB_hash(const char* input, char* output, uint32_t len)
{
    ...
    yespower_tls((const uint8_t *)input, len, &yespower_1_0_litb, (yespower_binary_t *)output);
}
...
void yespowerTIDE_hash(const char* input, char* output, uint32_t len)
{
    ...
    yespower_tls((const uint8_t *)input, len, &yespower_1_0_tide, (yespower_binary_t *)output);
}
...
void cpupower_hash(const char* input, char* output, uint32_t len)
{
    	yespower_params_t yespower_1_0_cpupower = 
	{
    	...
    	yespower_tls((const uint8_t *)input, len, &yespower_1_0_cpupower, (yespower_binary_t *)output);
}
...
void yespowerMGPC_hash(const char* input, char* output, uint32_t len)
{
    ...
    yespower_tls((const uint8_t *)input, len, &yespower_1_0_MGPC, (yespower_binary_t *)output);
}
...
void yespowerARWN_hash(const char* input, char* output, uint32_t len)
{
    ...
    yespower_tls((const uint8_t *)input, len, &yespower_1_0_ARWN, (yespower_binary_t *)output);
}
